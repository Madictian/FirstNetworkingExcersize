...
public class TTTClient extends Application implements TTTConstants {
    ...
    public void start(Stage primaryStage) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                primaryStage.setTitle("TicTacTorClient");
    ...
    private void receiveInfoFromServer() throws IOException{
        ...
        if (status == PLAYER1_Won){
            ...
            if (myToken == 'X'){
                ...
                Platform.runLater(() -> {
                    lblStatus.setText("Player 2 (X) has won!");
                });
            }
        }
            ...
            if (myToken == 'O'){
                ...
                Platform.runLater(() -> lblStatus.setText("Player 2 has won (0)"));
            }
        }
        else if (status == Draw){
            continueToPlay = false;
